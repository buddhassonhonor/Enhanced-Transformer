...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # Input-dependent gating mechanism
        self.gate_proj = nn.Linear(hs, hs, bias=True)
    ...
    def forward(self, x):
        ...
        # Apply input-dependent gating and add as residual
        gate = torch.sigmoid(self.gate_proj(y_attn_output))
        y = y_attn_output + y_fused * gate
